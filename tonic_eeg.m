...
%         pop_eegplot(EEG, 1, 1, 0);
    ...
    if strcmp(step, 'maninject')
        ...
        cd(['/Users/shawn/Dropbox/Research/Stanford/wagner-lab/data_archive/spindrift/memory/include/', subid, '/eeg/ret/raw']);
        ...
        for i = 1:n_runs
            ...
            [ALLEEG, EEG, CURRENTSET] = pop_newset(ALLEEG, EEG, 1, 'setname', ...
                                [subid, '_test', num2str(r), '_', FILTER_TYPE], 'savenew', ...
                                [subid, '_test', r, suffix, 'e_', FILTER_TYPE, '.set'], ...
                                'overwrite', 'on', 'gui', 'off');
        end
        ...
        for i = 1:n_runs
            ...
            EEG = pop_loadset('filename', ...
                [pwd, '/', subid, '_test', num2str(r), suffix, 'e_', FILTER_TYPE, '.set']);
