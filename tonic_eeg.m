    ...
    for subj = 1:length(group)
        ...
        if strcmp(step, 'filter')
            ...
            for i = 1:n_runs
                ...
                %% Load dataset
                EEG = pop_loadset('filename', [subid, '_test', r, suffix, '.set'], 'filepath', ...
                                [datadir, subid, '/']);
            ...
            for i = 1:n_runs
                ...
                EEG = pop_loadset('filename', ...
                    [subid, '_test', num2str(r), suffix, 'e_', band, '_prestim.set']);
            ...
            raw_prestim_file = [datadir, '/', subid, '/eeg/ret/preproc/', subid, suffix, 'e_', band, '_prestim.csv'];
            ...
            erp_prestim_file = [datadir, '/', subid, '/eeg/ret/preproc/', subid, suffix, '_erp_prestim.csv'];
